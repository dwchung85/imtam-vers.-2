    ...
    <header className="sticky top-0 z-40 w-full bg-white/90 backdrop-blur-md border-b border-neutral-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <span className="font-black text-black tracking-tight text-xl">IMTAM</span>
          </div>
              ...
              <div className="relative" ref={menuRef}>
                ...
                >
                  <img
                    ...
                    className={`w-9 h-9 rounded-full object-cover transition-all border-[1.5px] border-black ${
                      menuOpen
